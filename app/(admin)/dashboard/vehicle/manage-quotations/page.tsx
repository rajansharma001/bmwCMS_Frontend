...
import QuotationFetch from "@/components/quotationComponents/QuotationFetch";
import QuotationInputForm from "@/components/quotationComponents/QuotationInputForm";
  ...
  return (
    <div className="w-full  px-10 p-10 relative">
      ...
      <div className="w-full">
        <QuotationFetch refreshTable={pageRefresh} />
      </div>
      {/* maintnance form */}
